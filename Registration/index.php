            ...
            <form method="POST" action="../api/register.php">
              <div class="overlap-group-wrapper">
                <div class="overlap-group-2">
                  <input type="text" name="username" class="Label-4" placeholder="Логин" class="text-wrapper-9"
                    id="Title4" required>
                </div>
              </div>
              <div class="view-4">
              ...
              <div class="view-5">
                <div class="overlap-4">
                  <input type="tel" name="phone" id="Title5" required pattern="^\+7\d{10}$"
                    title="Формат: +7XXXXXXXXXX (11 цифр)" class="Label-5" placeholder="Телефон" id="Title5" required>
                </div>
              </div>
              <div class="view-6">
                <div class="overlap-group-2">
              ...
              <div class="view-9">
                <div class="overlap-3">
                  <input type="password" name="password_confirm" class="Label-7" placeholder="Подтвердите пароль"
                    id="Title7" required>
                </div>
              </div>
              <div class="view-10">
