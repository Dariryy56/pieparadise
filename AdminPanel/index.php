    ...
    <div class="div">
      <div class="view">
       ...
       <div class="view">
                <div class="overlap-group">
                    <img class="image" src="../222img/лого.png" />
                    <a href="../index.php"><div class="text-wrapper">Главная</div></a>
                    <a href="../menu/1Bread.html"><div class="text-wrapper-2">Меню</div></a>
                    <a href="../aboutUs/index.html"><div class="text-wrapper-3">О нас</div></a>
                    <a href="../Contacts/index.php"><div class="text-wrapper-4">Контакты</div></a>
                    <p class="element">
                        <span class="span">Контакты:<br /></span>
                        <span class="text-wrapper-5">+</span>
                        <span class="text-wrapper-6">79876543210</span>
        ...
        <div class="view-12">
          <div class="overlap-6">
            ...
            <div class="view-14">
                 <a href="../menu/1Bread.html"><div class="text-wrapper-27">Контакты</div></a>
              <div class="overlap-7">
              ...
              <div class="text-wrapper-30">+79876543210</div></a>
            </div>
            <div class="view-15">
                <a href="../aboutUs/index.html"><div class="text-wrapper-31">О нас</div></a>
                <a href="../Contacts/index.php"><div class="text-wrapper-32">Оставить отзыв</div></a>
              <div class="overlap-9">
                 <div class="overlap-10">
                   <a href="../account/index.php"><div class="text-wrapper-35">Личный кабинет</div></a>
                  <img class="vector-2" src="https://c.animaapp.com/4tTGMD1p/img/vector-9.svg" />
                </div>
                   <a href="../Basket/index.php"><div class="text-wrapper-33">корзина</div></a>
                   <a href="../account/index.php"><div class="text-wrapper-34">заказы</div></a>
            ...
            <div class="view-16">
              <div class="overlap-11">
                <div class="overlap-12">
                  <a href="../menu/1Bread.html">
                  <div class="text-wrapper-36">Меню</div></a>
                  <img class="vector-3" src="https://c.animaapp.com/4tTGMD1p/img/vector-8.svg" />
                </div>
                 <a href="../menu/2Buns.html"><div class="text-wrapper-37">булочки</div></a>
                 <a href="../menu/6Patty.html"><div class="text-wrapper-38">пирожки</div></a>
                 <a href="../menu/5Cakes.html"><div class="text-wrapper-39">пирожные</div></a>
                 <a href="../menu/7Drinks.html"><div class="text-wrapper-40">напитки</div></a>
              </div>
            </div>
          </div>
        </div>
